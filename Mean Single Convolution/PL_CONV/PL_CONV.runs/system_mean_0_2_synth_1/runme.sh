...
HD_PWD='E:/MyPYNQ/PL_CONV/PL_CONV.runs/system_mean_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_mean_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_mean_0_2.tcl
