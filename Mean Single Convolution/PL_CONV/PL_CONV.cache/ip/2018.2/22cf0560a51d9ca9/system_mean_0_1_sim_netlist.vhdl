...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mean is
  ...
  signal \i_1_reg_133[7]_i_2_n_2\ : STD_LOGIC;
  ...
  signal \tmp_reg_138[0]_i_1_n_2\ : STD_LOGIC;
  signal \tmp_reg_138_reg_n_2_[0]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \i_1_reg_133[7]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \i_1_reg_133[8]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \i_1_reg_133[9]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \i_1_reg_133[9]_i_3\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of image_in_V_data_V_0_sel_rd_i_1 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \image_in_V_last_0_state[0]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \image_out_TDATA[0]_INST_0\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \image_out_TDATA[1]_INST_0\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \image_out_TDATA[4]_INST_0\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \image_out_TDATA[5]_INST_0\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \image_out_TDATA[6]_INST_0\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \image_out_TDATA[7]_INST_0\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \image_out_V_data_V_1_payload_A[0]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \image_out_V_data_V_1_payload_A[1]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \image_out_V_data_V_1_payload_A[2]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \image_out_V_data_V_1_payload_A[3]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \image_out_V_data_V_1_payload_A[4]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \image_out_V_data_V_1_payload_A[5]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \image_out_V_data_V_1_payload_A[6]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \image_out_V_data_V_1_payload_A[7]_i_2\ : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of \image_out_V_data_V_1_state[1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of image_out_V_last_1_sel_rd_i_1 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of image_out_V_last_1_sel_wr_i_1 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \image_out_V_last_1_state[0]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \j_1_reg_146[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \j_1_reg_146[2]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \j_1_reg_146[7]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \j_1_reg_146[8]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \j_1_reg_146[9]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \j_1_reg_146[9]_i_2\ : label is "soft_lutpair6";
begin
...
\i_1_reg_133[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\i_1_reg_133[8]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\i_1_reg_133[9]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"C6"
    )
        port map (
...
\i_1_reg_133[9]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
\tmp_reg_138[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
