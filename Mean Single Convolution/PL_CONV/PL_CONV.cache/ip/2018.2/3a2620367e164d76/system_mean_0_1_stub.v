...
/* synthesis syn_black_box black_box_pad_pin="ap_clk,ap_rst_n,image_in_TVALID,image_in_TREADY,image_in_TDATA[7:0],image_in_TDEST[0:0],image_in_TKEEP[0:0],image_in_TSTRB[0:0],image_in_TUSER[0:0],image_in_TLAST[0:0],image_in_TID[0:0],image_out_TVALID,image_out_TREADY,image_out_TDATA[7:0],image_out_TDEST[0:0],image_out_TKEEP[0:0],image_out_TSTRB[0:0],image_out_TUSER[0:0],image_out_TLAST[0:0],image_out_TID[0:0]" */;
  input ap_clk;
  input ap_rst_n;
