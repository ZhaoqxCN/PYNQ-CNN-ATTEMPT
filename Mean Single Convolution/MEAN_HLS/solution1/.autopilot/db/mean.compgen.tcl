...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 14 \
    name image_in_V_data \
    reset_level 0 \
    sync_rst true \
    corename {image_in} \
    metadata {  } \
    op interface \
    ports { image_in_TDATA { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'image_in_V_data'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 15 \
    name image_in_V_last \
    reset_level 0 \
    sync_rst true \
    corename {image_in} \
    metadata {  } \
    op interface \
    ports { image_in_TVALID { I 1 bit } image_in_TREADY { O 1 bit } image_in_TLAST { I 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'image_in_V_last'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 16 \
    name image_out_V_data \
    reset_level 0 \
    sync_rst true \
    corename {image_out} \
    metadata {  } \
    op interface \
    ports { image_out_TDATA { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'image_out_V_data'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 17 \
    name image_out_V_last \
    reset_level 0 \
    sync_rst true \
    corename {image_out} \
    metadata {  } \
    op interface \
    ports { image_out_TVALID { O 1 bit } image_out_TREADY { I 1 bit } image_out_TLAST { O 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'image_out_V_last'"
}
}
