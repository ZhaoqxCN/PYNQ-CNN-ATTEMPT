...
set DataType0 [list "AXI_STREAM" "struct AXI_STREAM" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
set Port0 [list $PortName0 $Interface0 $DataType0 $Pointer0 $Dims0 $Const0 $Volatile0 $ArrayOpt0]
lappend PortList $Port0
set PortName1 "image_out"
set BitWidth1 "64"
set ArrayOpt1 ""
set Const1 "0"
set Volatile1 "0"
...
set DataType1 [list "AXI_STREAM" "struct AXI_STREAM" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
