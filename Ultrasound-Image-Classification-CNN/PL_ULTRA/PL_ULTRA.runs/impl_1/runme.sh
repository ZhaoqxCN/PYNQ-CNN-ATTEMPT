...
HD_PWD='E:/PYNQ-CNN-ATTEMPT/Ultrasound-Image-Classification-CNN/PL_ULTRA/PL_ULTRA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ultra_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ultra_wrapper.tcl -notrace
