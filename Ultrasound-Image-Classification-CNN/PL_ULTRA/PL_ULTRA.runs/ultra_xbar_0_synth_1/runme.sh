...
HD_PWD='E:/MyPYNQ/PL_ULTRA/PL_ULTRA.runs/ultra_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ultra_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ultra_xbar_0.tcl
