...
HD_PWD='E:/MyPYNQ/PL_ULTRA/PL_ULTRA.runs/ultra_xlconcat_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ultra_xlconcat_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ultra_xlconcat_0_0.tcl
