...
HD_PWD='E:/PYNQ-CNN-ATTEMPT/Ultrasound-Image-Classification-CNN/PL_ULTRA/PL_ULTRA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ultra_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ultra_wrapper.tcl
