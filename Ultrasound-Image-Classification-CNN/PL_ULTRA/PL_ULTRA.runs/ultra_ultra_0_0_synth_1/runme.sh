...
HD_PWD='E:/PYNQ-CNN-ATTEMPT/Ultrasound-Image-Classification-CNN/PL_ULTRA/PL_ULTRA.runs/ultra_ultra_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ultra_ultra_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ultra_ultra_0_0.tcl
