...
#ifndef __ultra_mul_mul_12s0iy__HH__
#define __ultra_mul_mul_12s0iy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_mul_mul_12s0iy) {
    ...
    SC_CTOR(ultra_mul_mul_12s0iy):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
