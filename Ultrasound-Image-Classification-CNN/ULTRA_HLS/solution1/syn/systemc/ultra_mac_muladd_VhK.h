...
#ifndef __ultra_mac_muladd_VhK__HH__
#define __ultra_mac_muladd_VhK__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_mac_muladd_VhK) {
    ...
    SC_CTOR(ultra_mac_muladd_VhK):  simcore_mac_2_U ("simcore_mac_2_U") {
