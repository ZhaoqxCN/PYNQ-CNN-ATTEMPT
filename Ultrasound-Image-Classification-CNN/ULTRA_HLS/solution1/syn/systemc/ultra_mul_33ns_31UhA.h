...
#ifndef __ultra_mul_33ns_31UhA__HH__
#define __ultra_mul_33ns_31UhA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_mul_33ns_31UhA) {
    ...
    SC_CTOR(ultra_mul_33ns_31UhA):  ACMP_mul_us_U ("ACMP_mul_us_U") {
