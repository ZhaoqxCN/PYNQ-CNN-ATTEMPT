...
#ifndef __ultra_mul_mul_12sWhU__HH__
#define __ultra_mul_mul_12sWhU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_mul_mul_12sWhU) {
    ...
    SC_CTOR(ultra_mul_mul_12sWhU):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
