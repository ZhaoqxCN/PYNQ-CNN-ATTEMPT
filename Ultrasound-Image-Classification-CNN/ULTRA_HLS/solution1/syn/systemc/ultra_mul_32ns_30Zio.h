...
#ifndef __ultra_mul_32ns_30Zio__HH__
#define __ultra_mul_32ns_30Zio__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_mul_32ns_30Zio) {
    ...
    SC_CTOR(ultra_mul_32ns_30Zio):  ACMP_mul_us_U ("ACMP_mul_us_U") {
