...
#ifndef __ultra_mul_32s_32sbkb__HH__
#define __ultra_mul_32s_32sbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_mul_32s_32sbkb) {
    ...
    SC_CTOR(ultra_mul_32s_32sbkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
