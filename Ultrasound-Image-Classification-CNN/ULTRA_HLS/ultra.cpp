...
#pragma HLS STREAM variable = connect_0 depth = 1024
#pragma HLS STREAM variable = connect_1 depth = 1024
#pragma HLS STREAM variable = connect_2 depth = 1024
#pragma HLS STREAM variable = connect_3 depth = 1024
#pragma HLS STREAM variable = connect_4 depth = 1024
#pragma HLS STREAM variable = connect_5 depth = 1024
#pragma HLS STREAM variable = connect_6 depth = 1024
#pragma HLS STREAM variable = connect_7 depth = 1024
#pragma HLS STREAM variable = connect_8 depth = 1024
