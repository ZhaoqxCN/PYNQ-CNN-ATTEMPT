...
HD_PWD='E:/MyPYNQ/PL_CNN/PL_CNN.runs/system_cnn_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_cnn_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_cnn_0_0.tcl
