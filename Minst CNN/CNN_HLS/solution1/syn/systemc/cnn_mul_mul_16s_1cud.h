...
#ifndef __cnn_mul_mul_16s_1cud__HH__
#define __cnn_mul_mul_16s_1cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_16s_1cud) {
    ...
    SC_CTOR(cnn_mul_mul_16s_1cud):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
