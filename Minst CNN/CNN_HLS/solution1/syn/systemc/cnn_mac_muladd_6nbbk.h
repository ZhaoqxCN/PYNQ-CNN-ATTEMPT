...
#ifndef __cnn_mac_muladd_6nbbk__HH__
#define __cnn_mac_muladd_6nbbk__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_6nbbk) {
    ...
    SC_CTOR(cnn_mac_muladd_6nbbk):  simcore_mac_0_U ("simcore_mac_0_U") {
