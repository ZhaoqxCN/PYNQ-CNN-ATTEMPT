...
architecture behav of AXI_DMA_SLAVE is 
    ...
    constant ap_ST_fsm_pp0_stage0 : STD_LOGIC_VECTOR (24 downto 0) := "0000000001000000000000000";
    ...
    constant ap_ST_fsm_pp1_stage0 : STD_LOGIC_VECTOR (24 downto 0) := "1000000000000000000000000";
    ...
    signal tmp_74_reg_299 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_pp0_stage0 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage0 : signal is "none";
    signal ap_enable_reg_pp0_iter1 : STD_LOGIC := '0';
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal tmp_75_reg_275 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_data_V_1_reg_202 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_block_state3 : BOOLEAN;
    signal tmp_data_V_2_reg_207 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_block_state4 : BOOLEAN;
    signal tmp_data_V_3_reg_212 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_block_state5 : BOOLEAN;
    signal tmp_data_V_4_reg_218 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_block_state6 : BOOLEAN;
    signal tmp_data_V_5_reg_223 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_block_state7 : BOOLEAN;
    signal ap_block_state8 : BOOLEAN;
    signal tmp_72_fu_124_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal rhs_V_fu_130_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_174_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp3_reg_260 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state10 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state10 : signal is "none";
    signal grp_fu_180_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp4_reg_265 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_136_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal KER_bound_reg_270 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state15 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state15 : signal is "none";
    signal tmp_75_fu_144_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state16_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state17_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal i_4_fu_149_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal grp_fu_186_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp1_reg_284 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state20 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state20 : signal is "none";
    signal grp_fu_192_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp2_reg_289 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_155_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal IFM_bound_reg_294 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state25 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state25 : signal is "none";
    signal tmp_74_fu_163_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state26_pp1_stage0_iter0 : BOOLEAN;
    signal ap_block_state27_pp1_stage0_iter1 : BOOLEAN;
    signal ap_block_pp1_stage0_11001 : BOOLEAN;
    signal i_s_fu_168_p2 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    signal i1_cast_fu_140_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state21 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state21 : signal is "none";
    signal i_cast_fu_159_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    cnn_mul_32s_32s_3bkb_U1 : component cnn_mul_32s_32s_3bkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    cnn_mul_32s_32s_3bkb_U2 : component cnn_mul_32s_32s_3bkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    cnn_mul_mul_16s_1cud_U3 : component cnn_mul_mul_16s_1cud
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 16,
    ...
    cnn_mul_mul_16s_1cud_U4 : component cnn_mul_mul_16s_1cud
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 16,
    ...
    cnn_mul_mul_16s_1cud_U5 : component cnn_mul_mul_16s_1cud
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 16,
    ...
    cnn_mul_mul_16s_1cud_U6 : component cnn_mul_mul_16s_1cud
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 16,
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_const_logic_1 = ap_condition_pp0_exit_iter0_state16))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_75_fu_144_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_74_fu_163_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
    ...
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state8 => 
                if ((not(((stream_in_V_data_V_0_vld_out = ap_const_logic_0) or (stream_out_V_V_full_n = ap_const_logic_0))) and (tmp_s_reg_198 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state8))) then
                    ap_NS_fsm <= ap_ST_fsm_state19;
                elsif ((not(((stream_in_V_data_V_0_vld_out = ap_const_logic_0) or (stream_out_V_V_full_n = ap_const_logic_0))) and (tmp_s_reg_198 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state8))) then
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if (not(((tmp_75_fu_144_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1)))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif (((tmp_75_fu_144_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then
            ...
            when ap_ST_fsm_pp1_stage0 => 
                if (not(((tmp_74_fu_163_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp1_stage0_subdone) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1)))) then
                    ap_NS_fsm <= ap_ST_fsm_pp1_stage0;
                elsif (((tmp_74_fu_163_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp1_stage0_subdone) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state18;
                else
                    ap_NS_fsm <= ap_ST_fsm_pp1_stage0;
                end if;
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(stream_in_V_data_V_0_vld_out, stream_out_V_V_full_n, ap_enable_reg_pp0_iter1, tmp_75_reg_275)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((tmp_75_reg_275 = ap_const_lv1_1) and (stream_out_V_V_full_n = ap_const_logic_0)) or ((tmp_75_reg_275 = ap_const_lv1_1) and (stream_in_V_data_V_0_vld_out = ap_const_logic_0))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(stream_in_V_data_V_0_vld_out, stream_out_V_V_full_n, ap_enable_reg_pp0_iter1, tmp_75_reg_275)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((tmp_75_reg_275 = ap_const_lv1_1) and (stream_out_V_V_full_n = ap_const_logic_0)) or ((tmp_75_reg_275 = ap_const_lv1_1) and (stream_in_V_data_V_0_vld_out = ap_const_logic_0))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(stream_in_V_data_V_0_vld_out, stream_out_V_V_full_n, ap_enable_reg_pp0_iter1, tmp_75_reg_275)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((tmp_75_reg_275 = ap_const_lv1_1) and (stream_out_V_V_full_n = ap_const_logic_0)) or ((tmp_75_reg_275 = ap_const_lv1_1) and (stream_in_V_data_V_0_vld_out = ap_const_logic_0))));
    end process;

        ap_block_pp1_stage0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_pp1_stage0_01001_assign_proc : process(stream_in_V_data_V_0_vld_out, stream_out_V_V_full_n, ap_enable_reg_pp1_iter1, tmp_74_reg_299)
    begin
                ap_block_pp1_stage0_01001 <= ((ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (((tmp_74_reg_299 = ap_const_lv1_1) and (stream_out_V_V_full_n = ap_const_logic_0)) or ((tmp_74_reg_299 = ap_const_lv1_1) and (stream_in_V_data_V_0_vld_out = ap_const_logic_0))));
    end process;


    ap_block_pp1_stage0_11001_assign_proc : process(stream_in_V_data_V_0_vld_out, stream_out_V_V_full_n, ap_enable_reg_pp1_iter1, tmp_74_reg_299)
    begin
                ap_block_pp1_stage0_11001 <= ((ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (((tmp_74_reg_299 = ap_const_lv1_1) and (stream_out_V_V_full_n = ap_const_logic_0)) or ((tmp_74_reg_299 = ap_const_lv1_1) and (stream_in_V_data_V_0_vld_out = ap_const_logic_0))));
    end process;


    ap_block_pp1_stage0_subdone_assign_proc : process(stream_in_V_data_V_0_vld_out, stream_out_V_V_full_n, ap_enable_reg_pp1_iter1, tmp_74_reg_299)
    begin
                ap_block_pp1_stage0_subdone <= ((ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (((tmp_74_reg_299 = ap_const_lv1_1) and (stream_out_V_V_full_n = ap_const_logic_0)) or ((tmp_74_reg_299 = ap_const_lv1_1) and (stream_in_V_data_V_0_vld_out = ap_const_logic_0))));
    end process;
    ...
    ap_block_state17_pp0_stage0_iter1_assign_proc : process(stream_in_V_data_V_0_vld_out, stream_out_V_V_full_n, tmp_75_reg_275)
    begin
                ap_block_state17_pp0_stage0_iter1 <= (((tmp_75_reg_275 = ap_const_lv1_1) and (stream_out_V_V_full_n = ap_const_logic_0)) or ((tmp_75_reg_275 = ap_const_lv1_1) and (stream_in_V_data_V_0_vld_out = ap_const_logic_0)));
    end process;
    ...
    ap_block_state27_pp1_stage0_iter1_assign_proc : process(stream_in_V_data_V_0_vld_out, stream_out_V_V_full_n, tmp_74_reg_299)
    begin
                ap_block_state27_pp1_stage0_iter1 <= (((tmp_74_reg_299 = ap_const_lv1_1) and (stream_out_V_V_full_n = ap_const_logic_0)) or ((tmp_74_reg_299 = ap_const_lv1_1) and (stream_in_V_data_V_0_vld_out = ap_const_logic_0)));
    end process;
    ...
    ap_condition_pp0_exit_iter0_state16_assign_proc : process(tmp_75_fu_144_p2)
    begin
        if ((tmp_75_fu_144_p2 = ap_const_lv1_0)) then 
    ...
    ap_condition_pp1_exit_iter0_state26_assign_proc : process(tmp_74_fu_163_p2)
    begin
        if ((tmp_74_fu_163_p2 = ap_const_lv1_0)) then 
    ...
    grp_fu_174_ce_assign_proc : process(stream_in_V_data_V_0_vld_out, stream_out_V_V_full_n, ap_CS_fsm_state8, ap_CS_fsm_state10, ap_CS_fsm_state9)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state9) or (ap_const_logic_1 = ap_CS_fsm_state10) or (not(((stream_in_V_data_V_0_vld_out = ap_const_logic_0) or (stream_out_V_V_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state8)))) then 
    ...
    grp_fu_174_p0 <= tmp_72_fu_124_p1(16 - 1 downto 0);
    grp_fu_174_p1 <= tmp_72_fu_124_p1(16 - 1 downto 0);

    grp_fu_180_ce_assign_proc : process(stream_in_V_data_V_0_vld_out, stream_out_V_V_full_n, ap_CS_fsm_state8, ap_CS_fsm_state10, ap_CS_fsm_state9)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state9) or (ap_const_logic_1 = ap_CS_fsm_state10) or (not(((stream_in_V_data_V_0_vld_out = ap_const_logic_0) or (stream_out_V_V_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state8)))) then 
    ...
    grp_fu_186_ce_assign_proc : process(stream_in_V_data_V_0_vld_out, stream_out_V_V_full_n, ap_CS_fsm_state8, ap_CS_fsm_state20, ap_CS_fsm_state19)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state19) or (ap_const_logic_1 = ap_CS_fsm_state20) or (not(((stream_in_V_data_V_0_vld_out = ap_const_logic_0) or (stream_out_V_V_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state8)))) then 
    ...
    grp_fu_192_ce_assign_proc : process(stream_in_V_data_V_0_vld_out, stream_out_V_V_full_n, ap_CS_fsm_state8, ap_CS_fsm_state20, ap_CS_fsm_state19)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state19) or (ap_const_logic_1 = ap_CS_fsm_state20) or (not(((stream_in_V_data_V_0_vld_out = ap_const_logic_0) or (stream_out_V_V_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state8)))) then 
    ...
    grp_fu_192_p0 <= rhs_V_fu_130_p1(16 - 1 downto 0);
    grp_fu_192_p1 <= rhs_V_fu_130_p1(16 - 1 downto 0);
    i1_cast_fu_140_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i1_reg_85),32));
    i_4_fu_149_p2 <= std_logic_vector(unsigned(i1_reg_85) + unsigned(ap_const_lv31_1));
    i_cast_fu_159_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_reg_96),32));
    i_s_fu_168_p2 <= std_logic_vector(unsigned(i_reg_96) + unsigned(ap_const_lv31_1));
    ...
    begin
        ...
        rhs_V_fu_130_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_data_V_4_reg_218),32));
    ...
    stream_in_TDATA_blk_n_assign_proc : process(stream_in_V_data_V_0_state, ap_CS_fsm_state2, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state5, ap_CS_fsm_state6, ap_CS_fsm_state7, ap_CS_fsm_state8, ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter1, ap_block_pp1_stage0, tmp_74_reg_299, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, tmp_75_reg_275)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state8) or (ap_const_logic_1 = ap_CS_fsm_state7) or (ap_const_logic_1 = ap_CS_fsm_state6) or (ap_const_logic_1 = ap_CS_fsm_state5) or (ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3) or (ap_const_logic_1 = ap_CS_fsm_state2) or ((tmp_75_reg_275 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((tmp_74_reg_299 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0)))) then 
    ...
    begin
        ...
        tmp_72_fu_124_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_data_V_2_reg_207),32));

    tmp_74_fu_163_p2 <= "1" when (signed(i_cast_fu_159_p1) < signed(IFM_bound_reg_294)) else "0";
    tmp_75_fu_144_p2 <= "1" when (signed(i1_cast_fu_140_p1) < signed(KER_bound_reg_270)) else "0";
