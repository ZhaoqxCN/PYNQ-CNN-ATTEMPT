...
parameter    ap_ST_fsm_pp1_stage0 = 27'd67108864;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((stream_out_V_data_V_1_ack_in == 1'b0) | (stream_out_V_last_1_ack_in == 1'b0)) & (1'b1 == ap_CS_fsm_state20))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b0 == ap_block_pp1_stage0_subdone)) begin
            if ((1'b1 == ap_condition_pp1_exit_iter0_state29)) begin
...
always @ (*) begin
    if ((~((stream_out_V_data_V_1_ack_in == 1'b0) | (stream_out_V_last_1_ack_in == 1'b0)) & (1'b1 == ap_CS_fsm_state20))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state21) | (1'b1 == ap_CS_fsm_state22) | ((stream_out_V_data_V_1_ack_in == 1'b1) & (1'b1 == ap_CS_fsm_state8)))) begin
        grp_fu_217_ce = 1'b1;
    end else begin
        grp_fu_217_ce = 1'b0;
    end
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state19_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state18_io) | ((tmp_82_reg_300 == 1'd1) & (stream_in_V_V_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state19_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state18_io) | ((tmp_82_reg_300 == 1'd1) & (stream_in_V_V_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_pp1_stage0_11001 = (((1'b1 == ap_block_state31_io) & (ap_enable_reg_pp1_iter2 == 1'b1)) | ((ap_enable_reg_pp1_iter1 == 1'b1) & ((1'b1 == ap_block_state30_io) | ((tmp_81_reg_335 == 1'd1) & (stream_in_V_V_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = (((1'b1 == ap_block_state31_io) & (ap_enable_reg_pp1_iter2 == 1'b1)) | ((ap_enable_reg_pp1_iter1 == 1'b1) & ((1'b1 == ap_block_state30_io) | ((tmp_81_reg_335 == 1'd1) & (stream_in_V_V_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state18_io = ((tmp_82_reg_300 == 1'd1) & (stream_out_V_data_V_1_ack_in == 1'b0));
end

always @ (*) begin
    ap_block_state18_pp0_stage0_iter1 = ((tmp_82_reg_300 == 1'd1) & (stream_in_V_V_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state19_io = ((tmp_82_reg_300_pp0_iter1_reg == 1'd1) & (stream_out_V_data_V_1_ack_in == 1'b0));
end

assign ap_block_state19_pp0_stage0_iter2 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state20 = ((stream_out_V_data_V_1_ack_in == 1'b0) | (stream_out_V_last_1_ack_in == 1'b0));
end

assign ap_block_state29_pp1_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state30_io = ((tmp_81_reg_335 == 1'd1) & (stream_out_V_data_V_1_ack_in == 1'b0));
end

always @ (*) begin
    ap_block_state30_pp1_stage0_iter1 = ((tmp_81_reg_335 == 1'd1) & (stream_in_V_V_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state31_io = ((tmp_81_reg_335_pp1_iter1_reg == 1'd1) & (stream_out_V_data_V_1_ack_in == 1'b0));
end
