...
read_ip -quiet e:/MyPYNQ/PL_ULTRA/PL_ULTRA.srcs/sources_1/bd/ultra/ip/ultra_axi_smc_0/ultra_axi_smc_0.xci
...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir E:/MyPYNQ/PL_ULTRA/PL_ULTRA.runs/ultra_axi_smc_0_synth_1 -new_name ultra_axi_smc_0 -ip [get_ips ultra_axi_smc_0]]

if { $cached_ip eq {} } {
close [open __synthesis_is_running__ w]

synth_design -top ultra_axi_smc_0 -part xc7z020clg400-1 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix ultra_axi_smc_0_ ultra_axi_smc_0.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ ultra_axi_smc_0_stub.v
 lappend ipCachedFiles ultra_axi_smc_0_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ ultra_axi_smc_0_stub.vhdl
 lappend ipCachedFiles ultra_axi_smc_0_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ ultra_axi_smc_0_sim_netlist.v
 lappend ipCachedFiles ultra_axi_smc_0_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ ultra_axi_smc_0_sim_netlist.vhdl
 lappend ipCachedFiles ultra_axi_smc_0_sim_netlist.vhdl
set TIME_taken [expr [clock seconds] - $TIME_start]

 config_ip_cache -add -dcp ultra_axi_smc_0.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips ultra_axi_smc_0]
}

rename_ref -prefix_all ultra_axi_smc_0_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef ultra_axi_smc_0.dcp
create_report "ultra_axi_smc_0_synth_1_synth_report_utilization_0" "report_utilization -file ultra_axi_smc_0_utilization_synth.rpt -pb ultra_axi_smc_0_utilization_synth.pb"

if { [catch {
  file copy -force E:/MyPYNQ/PL_ULTRA/PL_ULTRA.runs/ultra_axi_smc_0_synth_1/ultra_axi_smc_0.dcp e:/MyPYNQ/PL_ULTRA/PL_ULTRA.srcs/sources_1/bd/ultra/ip/ultra_axi_smc_0/ultra_axi_smc_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub e:/MyPYNQ/PL_ULTRA/PL_ULTRA.srcs/sources_1/bd/ultra/ip/ultra_axi_smc_0/ultra_axi_smc_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub e:/MyPYNQ/PL_ULTRA/PL_ULTRA.srcs/sources_1/bd/ultra/ip/ultra_axi_smc_0/ultra_axi_smc_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim e:/MyPYNQ/PL_ULTRA/PL_ULTRA.srcs/sources_1/bd/ultra/ip/ultra_axi_smc_0/ultra_axi_smc_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim e:/MyPYNQ/PL_ULTRA/PL_ULTRA.srcs/sources_1/bd/ultra/ip/ultra_axi_smc_0/ultra_axi_smc_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force E:/MyPYNQ/PL_ULTRA/PL_ULTRA.runs/ultra_axi_smc_0_synth_1/ultra_axi_smc_0_stub.v e:/MyPYNQ/PL_ULTRA/PL_ULTRA.srcs/sources_1/bd/ultra/ip/ultra_axi_smc_0/ultra_axi_smc_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force E:/MyPYNQ/PL_ULTRA/PL_ULTRA.runs/ultra_axi_smc_0_synth_1/ultra_axi_smc_0_stub.vhdl e:/MyPYNQ/PL_ULTRA/PL_ULTRA.srcs/sources_1/bd/ultra/ip/ultra_axi_smc_0/ultra_axi_smc_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force E:/MyPYNQ/PL_ULTRA/PL_ULTRA.runs/ultra_axi_smc_0_synth_1/ultra_axi_smc_0_sim_netlist.v e:/MyPYNQ/PL_ULTRA/PL_ULTRA.srcs/sources_1/bd/ultra/ip/ultra_axi_smc_0/ultra_axi_smc_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force E:/MyPYNQ/PL_ULTRA/PL_ULTRA.runs/ultra_axi_smc_0_synth_1/ultra_axi_smc_0_sim_netlist.vhdl e:/MyPYNQ/PL_ULTRA/PL_ULTRA.srcs/sources_1/bd/ultra/ip/ultra_axi_smc_0/ultra_axi_smc_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir E:/MyPYNQ/PL_ULTRA/PL_ULTRA.ip_user_files/ip/ultra_axi_smc_0]} {
  catch { 
    file copy -force e:/MyPYNQ/PL_ULTRA/PL_ULTRA.srcs/sources_1/bd/ultra/ip/ultra_axi_smc_0/ultra_axi_smc_0_stub.v E:/MyPYNQ/PL_ULTRA/PL_ULTRA.ip_user_files/ip/ultra_axi_smc_0
  }
}

if {[file isdir E:/MyPYNQ/PL_ULTRA/PL_ULTRA.ip_user_files/ip/ultra_axi_smc_0]} {
  catch { 
    file copy -force e:/MyPYNQ/PL_ULTRA/PL_ULTRA.srcs/sources_1/bd/ultra/ip/ultra_axi_smc_0/ultra_axi_smc_0_stub.vhdl E:/MyPYNQ/PL_ULTRA/PL_ULTRA.ip_user_files/ip/ultra_axi_smc_0
  }
}
