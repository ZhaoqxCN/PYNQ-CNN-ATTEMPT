...
HD_PWD='E:/MyPYNQ/PL_ULTRA/PL_ULTRA.runs/ultra_v_axi4s_vid_out_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ultra_v_axi4s_vid_out_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ultra_v_axi4s_vid_out_0_0.tcl
