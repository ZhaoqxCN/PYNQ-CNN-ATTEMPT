...
#ifndef __ultra_mul_mul_8s_WhU__HH__
#define __ultra_mul_mul_8s_WhU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_mul_mul_8s_WhU) {
    ...
    SC_CTOR(ultra_mul_mul_8s_WhU):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
