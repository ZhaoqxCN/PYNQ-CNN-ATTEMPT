...
#ifndef __ultra_mul_mul_8s_Thq__HH__
#define __ultra_mul_mul_8s_Thq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_mul_mul_8s_Thq) {
    ...
    SC_CTOR(ultra_mul_mul_8s_Thq):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
