...
#ifndef __ultra_mac_muladd_Shg__HH__
#define __ultra_mac_muladd_Shg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_mac_muladd_Shg) {
    ...
    SC_CTOR(ultra_mac_muladd_Shg):  simcore_mac_2_U ("simcore_mac_2_U") {
