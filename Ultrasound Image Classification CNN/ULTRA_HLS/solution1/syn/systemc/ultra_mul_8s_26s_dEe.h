...
#ifndef __ultra_mul_8s_26s_dEe__HH__
#define __ultra_mul_8s_26s_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_mul_8s_26s_dEe) {
    ...
    SC_CTOR(ultra_mul_8s_26s_dEe):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
